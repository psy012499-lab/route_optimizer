...
def make_sample_excel() -> io.BytesIO:
    # input.xlsx 실측 데이터에서 검증된 주소 20개 사용
    DEPART = "부산광역시 동구 조방로 15"
    sample_rows = [
        # 코스 1 (통상순로 1~10)
        (DEPART, "부산광역시 동구 초량중로 45",           1,  1),
        (DEPART, "부산광역시 동구 초량중로 43-1",         1,  2),
        (DEPART, "부산광역시 동구 초량중로 43",           1,  3),
        (DEPART, "부산광역시 동구 초량중로 41",           1,  4),
        (DEPART, "부산광역시 동구 초량중로 39-1",         1,  5),
        (DEPART, "부산광역시 동구 초량중로 35",           1,  6),
        (DEPART, "부산광역시 동구 초량중로35번길 5",      1,  7),
        (DEPART, "부산광역시 동구 초량중로35번길 6",      1,  8),
        (DEPART, "부산광역시 동구 초량중로 33",           1,  9),
        (DEPART, "부산광역시 동구 초량중로 31",           1, 10),
        # 코스 2 (통상순로 1~10, 이상 주소 "-" 제외)
        (DEPART, "부산광역시 동구 초량중로 23-1",         2,  1),
        (DEPART, "부산광역시 동구 초량중로 23",           2,  2),
        (DEPART, "부산광역시 동구 중앙대로179번길 30-1",  2,  3),
        (DEPART, "부산광역시 동구 중앙대로179번길 30",    2,  4),
        (DEPART, "부산광역시 동구 중앙대로179번길 30-2",  2,  5),
        (DEPART, "부산광역시 동구 중앙대로179번길 29",    2,  6),
        (DEPART, "부산광역시 동구 중앙대로179번길 27-4",  2,  7),
        (DEPART, "부산광역시 동구 중앙대로179번길 27-6",  2,  8),
        (DEPART, "부산광역시 동구 중앙대로179번길 27-8",  2,  9),
        (DEPART, "부산광역시 동구 중앙대로179번길 27-12", 2, 10),
    ]
