...
def make_sample_excel() -> io.BytesIO:
    # input.xlsx 실측 데이터 — 4개 코스(초량중로·중앙대로·대영로·초량상로) 30건
    DEPART = "부산광역시 동구 조방로 15"
    sample_rows = [
        # 코스 1 — 초량중로
        (DEPART, "부산광역시 동구 초량중로 45",          1,  1),
        (DEPART, "부산광역시 동구 초량중로 43-1",        1,  3),
        (DEPART, "부산광역시 동구 초량중로 43",          1,  4),
        (DEPART, "부산광역시 동구 초량중로 41",          1,  5),
        (DEPART, "부산광역시 동구 초량중로 39-1",        1,  6),
        (DEPART, "부산광역시 동구 초량중로 35",          1,  7),
        (DEPART, "부산광역시 동구 초량중로35번길 5",     1,  8),
        (DEPART, "부산광역시 동구 초량중로35번길 6",     1,  9),
        # 코스 7 — 중앙대로
        ...
        # 코스 20 — 초량상로
        (DEPART, "부산광역시 동구 초량상로 61",          20,  1),
        (DEPART, "부산광역시 동구 초량상로 61-1",        20,  2),
        (DEPART, "부산광역시 동구 초량상로 61-2",        20,  3),
        (DEPART, "부산광역시 동구 초량상로63번길 5",     20,  4),
        (DEPART, "부산광역시 동구 초량상로63번길 7",     20,  5),
        (DEPART, "부산광역시 동구 초량상로63번길 9",     20,  6),
        (DEPART, "부산광역시 동구 초량상로63번길 17",    20,  7),
    ]
