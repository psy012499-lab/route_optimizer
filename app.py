...
def make_sample_excel() -> io.BytesIO:
    # input.xlsx 실측 데이터 — 지리적으로 분산된 4개 코스 30건
    # 중앙대로(하단) · 대영로(중단) · 영초길(상단) · 중동길(별도구역)
    DEPART = "부산광역시 동구 조방로 15"
    sample_rows = [
        # 코스 7 — 중앙대로 (하단부)
        (DEPART, "부산광역시 동구 중앙대로 189",         7,  1),
        (DEPART, "부산광역시 동구 중앙대로 185",         7,  2),
        (DEPART, "부산광역시 동구 중앙대로 191",         7,  3),
        (DEPART, "부산광역시 동구 중앙대로 183",         7,  4),
        (DEPART, "부산광역시 동구 중앙대로 181",         7,  5),
        (DEPART, "부산광역시 동구 중앙대로 175",         7,  6),
        (DEPART, "부산광역시 동구 중앙대로 167",         7,  7),
        # 코스 16 — 대영로239번길 (중단부)
        (DEPART, "부산광역시 동구 대영로239번길 59",     16,  1),
        (DEPART, "부산광역시 동구 대영로239번길 60",     16,  2),
        (DEPART, "부산광역시 동구 대영로239번길 57",     16,  3),
        (DEPART, "부산광역시 동구 대영로239번길 55",     16,  4),
        (DEPART, "부산광역시 동구 대영로239번길 56",     16,  6),
        (DEPART, "부산광역시 동구 대영로239번길 53-5",   16,  7),
        (DEPART, "부산광역시 동구 대영로239번길 53-4",   16,  8),
        (DEPART, "부산광역시 동구 대영로239번길 53-6",   16,  9),
        # 코스 50 — 영초길 (상단부)
        (DEPART, "부산광역시 동구 영초길 156",           50,  1),
        (DEPART, "부산광역시 동구 영초길 154",           50,  2),
        (DEPART, "부산광역시 동구 영초길148번길 9-8",    50,  3),
        (DEPART, "부산광역시 동구 영초길148번길 9-11",   50,  4),
        (DEPART, "부산광역시 동구 영초길148번길 9-9",    50,  5),
        (DEPART, "부산광역시 동구 영초길148번길 9-7",    50,  6),
        (DEPART, "부산광역시 동구 영초길148번길 9-6",    50,  7),
        (DEPART, "부산광역시 동구 영초길148번길 9-5",    50,  8),
        # 코스 54 — 중동길1번길 (별도 구역)
        (DEPART, "부산광역시 동구 중동길1번길 11-1",     54,  1),
        (DEPART, "부산광역시 동구 중동길1번길 9-1",      54,  2),
        (DEPART, "부산광역시 동구 중동길1번길 9-2",      54,  3),
        (DEPART, "부산광역시 동구 중동길1번길 7",        54,  6),
        (DEPART, "부산광역시 동구 중동길1번길 7-1",      54,  7),
        (DEPART, "부산광역시 동구 중동길1번길 8",        54,  8),
        (DEPART, "부산광역시 동구 중동길1번길 5-1",      54,  9),
    ]
...
if use_sample:
    ...
    st.info("📋 샘플 데이터 사용 중 — 부산 동구 4코스·30건", icon="ℹ️")
