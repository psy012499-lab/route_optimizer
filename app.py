...
def make_sample_excel() -> io.BytesIO:
    sample_rows = [
        ...
        ("부산광역시 동구 중앙대로 270", "부산광역시 동구 수정로 8",        1, 3),
        ("부산광역시 동구 중앙대로 270", "부산광역시 동구 좌천로 22",       1, 4),
        ("부산광역시 동구 중앙대로 270", "부산광역시 동구 초량로 57",       1, 5),
        ("부산광역시 동구 중앙대로 270", "부산광역시 동구 범일로 85",       1, 6),
        ("부산광역시 동구 중앙대로 270", "부산광역시 동구 수정로 55",       1, 7),
        ("부산광역시 동구 중앙대로 270", "부산광역시 동구 좌천로 46",       1, 8),
        ("부산광역시 동구 중앙대로 270", "부산광역시 동구 초량로 120",      1, 9),
        ("부산광역시 동구 중앙대로 270", "부산광역시 동구 범일로 33",       1, 10),
        # 코스 2 — 부산 동구 도로명 주소
        ("부산광역시 동구 중앙대로 270", "부산광역시 동구 자성로 67",       2, 1),
        ("부산광역시 동구 중앙대로 270", "부산광역시 동구 중앙대로 419",    2, 2),
        ("부산광역시 동구 중앙대로 270", "부산광역시 동구 망양로 450",      2, 3),
        ("부산광역시 동구 중앙대로 270", "부산광역시 동구 초량로 84",       2, 4),
        ("부산광역시 동구 중앙대로 270", "부산광역시 동구 수정로 71",       2, 5),
        ("부산광역시 동구 중앙대로 270", "부산광역시 동구 범일로 148",      2, 6),
        ("부산광역시 동구 중앙대로 270", "부산광역시 동구 좌천로 90",       2, 7),
        ("부산광역시 동구 중앙대로 270", "부산광역시 동구 초량로 200",      2, 8),
        ("부산광역시 동구 중앙대로 270", "부산광역시 동구 수정로 111",      2, 9),
        ("부산광역시 동구 중앙대로 270", "부산광역시 동구 범일로 62",       2, 10),
    ]
